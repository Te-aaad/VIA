...
Route::middleware(['auth'])->prefix('seller')->name('seller.')->group(function () {
    ...
    // Orders Routes
    Route::get('/orders', [\App\Http\Controllers\OrderController::class, 'sellerIndex'])->name('orders.index');
    Route::get('/orders/{id}', [\App\Http\Controllers\OrderController::class, 'sellerShow'])->name('orders.show');
    ...
    // Check stall availability endpoint
    Route::post('/check-stall-availability', [\App\Http\Controllers\SellerController::class, 'checkStallAvailability'])->name('check-stall-availability');
    
    // Get available stalls endpoint
    Route::post('/get-available-stalls', [\App\Http\Controllers\SellerController::class, 'getAvailableStalls'])->name('get-available-stalls');
});
